...
<link rel="stylesheet" type="text/css" href='<?php echo get_stylesheet_directory_uri(); ?>/css/dark.css' />
<?php endif; ?>
...
nav[role="navigation"] .sf-menu a {
	font-family:'<?php echo $nav_font; ?>',Arial, Helvetica, sans-serif;
