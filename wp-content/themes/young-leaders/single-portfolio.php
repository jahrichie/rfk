				...
				<div class="twelve columns" role="main">
					...
					<div class="four columns">
						<section class="project-info" >
                        	<span class="info-label">Date: &nbsp;&nbsp;</span><span class="post-time"><?php the_time('F j, Y'); ?></span><br />
                             <?php 
                            $client = qs_get_meta('qs_client_name', get_the_ID());
							if($client): 
							?>
                            	<span class="info-label">Client: &nbsp;&nbsp;</span><span class="project-client"><?php echo $client; ?></span><br />
                            <?php endif; ?>
                            <?php
                            $website = qs_get_meta('qs_project_website', get_the_ID());
							if($website): 
							?>
                            	<span class="project-website"><a href="<?php echo $website; ?>" target="_blank">Launch Website</a></span><br />
                            <?php endif; ?>
